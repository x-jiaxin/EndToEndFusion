...
from model.StructureFeatureFusionNet import StructureFeatureFusionNet
...
dir_name = os.path.join(
    os.path.dirname(__file__), os.pardir, "CheckPoints_01", exp_name, "models"
)
...
def get_model():
    return StructureFeatureFusionNet()
